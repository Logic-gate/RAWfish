#!/bin/sh
## @file raw16-to-image.sh
## @brief Converts a Camera2 RAW16/JSON pair to PNG or JPEG.
##
## Dispatches the RAW16 metadata pair through sfos-raw16-to-ppm and an available
## image encoder for simple script-based conversion.
set -eu
