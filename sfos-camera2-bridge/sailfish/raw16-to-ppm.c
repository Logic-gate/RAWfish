/**
 * @file raw16-to-ppm.c
 * @brief Minimal RAW16/JSON to PPM converter.
 *
 * Reads Camera2 RAW16 pixels and bridge JSON metadata, applies black-level and
 * white-level correction, performs simple Bayer demosaic, and writes an sRGB PPM
 * image for script-based PNG/JPEG conversion.
 */
...
/**
 * @brief Convert RAW16 pixels to an sRGB PPM image.
 *
...
/**
 * @brief Command-line entry point for RAW16/JSON to PPM conversion.
 */
